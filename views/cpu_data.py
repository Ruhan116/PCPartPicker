...
class Ui_CPUPage(object):
    def setupUi(self, MainWindow):
        ...
        headers = ["id", "Name", "Socket", "Clock_Speed", "Turbo_Speed", "Cores", "Threads", "Action"]
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Clock_Speed"))
        item = self.table.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Turbo_Speed"))
        item = self.table.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Cores"))
